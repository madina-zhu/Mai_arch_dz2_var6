...
const deliveries = [
    {
        ...
        events: [
            { status: "created", timestamp: new Date("2026-05-10T10:30:00Z"), location: "Moscow", comment: "Delivery order created" },
            { status: "in_transit", timestamp: new Date("2026-05-11T08:00:00Z"), location: "Moscow Sorting Center", comment: "Parcel picked up" },
            { status: "delivered", timestamp: new Date("2026-05-12T16:00:00Z"), location: "Saint Petersburg", comment: "Delivered to receiver" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-11T11:30:00Z"), location: "Moscow", comment: "Delivery order created" },
            { status: "in_transit", timestamp: new Date("2026-05-12T09:00:00Z"), location: "Moscow Sorting Center", comment: "In transit to Kazan" }
        ]
    },
    {
        _id: uuid(),
        ...
        events: [
            { status: "created", timestamp: new Date("2026-05-12T12:30:00Z"), location: "Novosibirsk", comment: "Delivery order created" },
            { status: "in_transit", timestamp: new Date("2026-05-13T10:00:00Z"), location: "Novosibirsk Sorting Center", comment: "In transit" },
            { status: "delivered", timestamp: new Date("2026-05-14T14:00:00Z"), location: "Yekaterinburg", comment: "Delivered successfully" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-13T13:30:00Z"), location: "Yekaterinburg", comment: "Delivery order created" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-14T14:30:00Z"), location: "Kazan", comment: "Delivery order created" },
            { status: "in_transit", timestamp: new Date("2026-05-15T11:00:00Z"), location: "Kazan Sorting Center", comment: "In transit to Novosibirsk" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-15T15:30:00Z"), location: "Saint Petersburg", comment: "Delivery order created" }
        ]
    },
    {
        _id: uuid(),
        ...
        events: [
            { status: "created", timestamp: new Date("2026-05-16T16:30:00Z"), location: "Moscow", comment: "Delivery order created" },
            { status: "in_transit", timestamp: new Date("2026-05-17T09:00:00Z"), location: "Moscow Sorting Center", comment: "In transit to Sochi" },
            { status: "delivered", timestamp: new Date("2026-05-18T12:00:00Z"), location: "Sochi", comment: "Delivered to receiver" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-17T17:30:00Z"), location: "Yekaterinburg", comment: "Delivery order created" },
            { status: "cancelled", timestamp: new Date("2026-05-18T10:00:00Z"), location: "Yekaterinburg", comment: "Cancelled by sender" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-18T18:30:00Z"), location: "Novosibirsk", comment: "Delivery order created" }
        ]
    },
    {
        _id: uuid(),
        ...
        delivered_at: null,
        events: [
            { status: "created", timestamp: new Date("2026-05-19T19:30:00Z"), location: "Sochi", comment: "Delivery order created" },
            { status: "in_transit", timestamp: new Date("2026-05-20T08:00:00Z"), location: "Sochi Sorting Center", comment: "In transit to Moscow" }
        ]
    }
];
