...
// ============================================================================
// Aggregation 5: Average Delivery Time by Route
// ============================================================================
...
const routeStats = db.deliveries.aggregate([
    { $match: { status: "delivered", delivered_at: { $ne: null } } },
    {
        $group: {
...
// ============================================================================
// Aggregation 6: Parcels with Multiple Features
// ============================================================================

print("\n6. Parcels with Multiple Features:");
print("===================================");

const parcelsWithFeatures = db.parcels.aggregate([
    { $match: { features: { $exists: true, $ne: [] } } },
    { $addFields: { feature_count: { $size: "$features" } } },
    { $match: { feature_count: { $gte: 1 } } },
    {
        $project: {
            _id: 1,
            weight: 1,
