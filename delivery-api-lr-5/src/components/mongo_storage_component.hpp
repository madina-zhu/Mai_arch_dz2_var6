...
namespace components
{
  ...
  public:
    ...
    bool UpdateParcelStatus(const std::string &parcel_id, const std::string &status);
    ...
    bool UpdateDeliveryStatus(const std::string &delivery_id, const std::string &status,
                              const std::string &location, const std::string &comment);
  ...
  private:
    ...
    // Mapping functions
    userver::formats::bson::Value MapParcelToBson(const models::dto::ParcelCreateRequest &req);
    models::dto::ParcelResponse MapBsonToParcel(const userver::formats::bson::Value &doc);
    userver::formats::bson::Value MapDeliveryToBson(const models::dto::DeliveryCreateRequest &req);
    models::dto::DeliveryResponse MapBsonToDelivery(const userver::formats::bson::Value &doc);
