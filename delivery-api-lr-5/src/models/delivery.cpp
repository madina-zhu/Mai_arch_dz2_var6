...
namespace models::dto
{
  ...
  // ===================== SERIALIZE (DeliveryCreateRequest -> json) =====================
  ...
  // ===================== SERIALIZE (DeliveryResponse -> json) =====================
  ...
  // ===================== PARSE (json -> DeliveryEvent) =====================

  DeliveryEvent Parse(const userver::formats::json::Value &json,
  ...
  // ===================== PARSE (json -> DeliveryCreateRequest) =====================
