...
namespace handlers
{
      ...
      userver::server::request::RequestContext &) const
  {
    ...
    if (delivery_id == components::MongoStorageComponent::DATA_VIOLATION)
    {
    ...
    if (delivery_id == components::MongoStorageComponent::CONSTRAINT_VIOLATION)
    {
    ...
    // Инвалидируем кеш после создания новой доставки
